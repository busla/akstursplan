...
**Rotation rule:** No one drives two days in a row unless unavoidable. Thursday’s final drivers (per `index.html`) were Andri (2), Egill (4), Kristján (3), Valtýr (5), Hilmar (1), Valur (1), Einar Örn (3). Friday’s drivers (per `fostudagur.html`) are Leví (3), Andri (2, self-signed two days in a row), Bjarki (5), Arna (5), Svavar (2 — confirmed, but not in the roster and phone number still missing), Sæmi (4), Jón Levy (2) — so Saturday priority goes to **Hilmar (1), Valur (1), Egill (4), Kristján (3), Valtýr (5), Einar Örn (3), Ágúst (1+2), Sif (4)**, still subject to the critical rule above.
